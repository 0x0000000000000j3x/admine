    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(onPressed: () {
            showDialog(context: context, builder:
              ...
              builder: (context, setState) => AlertDialog(
                title: Row(
                  children: [
                    Image.asset('assets/img/stethoscope.png',height: h*0.05,width: w*0.05,),
                    Text('Add category',style: TextStyle(fontFamily: 'Montserrat'),),
                  ],
                ),
                ...
                actions: [
                  ...
                  Row(
                    children: [
                      ...
                      Text('Add an image',style: TextStyle(fontFamily: 'Montserrat'),),
                      SizedBox(
                        width: w*0.05,
                      ),
          ...
          }, icon: Icon(Icons.add_circle),color: Colors.white,iconSize: h*0.07,),
